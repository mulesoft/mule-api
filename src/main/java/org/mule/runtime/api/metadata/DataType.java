 ...
 * <p>
 * This may be a mime type for the type or for collections, the collection item type can be stored
...
public interface DataType<T> extends Serializable
{
    ...
    DataType<byte[]> BYTE_ARRAY_DATA_TYPE = new SimpleDataType<>(byte[].class, ANY_MIME_TYPE);
    DataType<String> STRING_DATA_TYPE = new SimpleDataType<>(String.class, ANY_MIME_TYPE);
    DataType<Object> OBJECT_DATA_TYPE = new SimpleDataType<>(Object.class, ANY_MIME_TYPE);
