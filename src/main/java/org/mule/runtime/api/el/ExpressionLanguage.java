...
public interface ExpressionLanguage extends Disposable {
  ...
  default List<ConstraintViolation> validate(String script, String nameIdentifier,
                                             ...
                                             Optional<MetadataType> outputType) {
    throw new UnsupportedOperationException("The current ExpressionLanguage does not support validate(String, String, "
        + "ValidationScopePhase, TypeBindings, Optional) method. Please update the "
   ...
   *
   * @since 1.5.0
   * @deprecated since 1.9.0. Use {@link #validate(String, String, ValidationPhase, TypeBindings, Optional)} with
   *             {@link ValidationPhase#SCOPE} instead.
   */
  @Deprecated
