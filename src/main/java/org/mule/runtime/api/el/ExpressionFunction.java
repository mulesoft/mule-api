...
/**
 * Representation of a function to be used by an {@link ExpressionExecutor}.
 ...
 * by the {@link ExpressionExecutor}. Thus, it is not necessary for implementations to validate the input.
 *
 * @since 1.0
 */
