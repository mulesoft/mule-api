 ...
 * types and using different policies. For example, clients of this API will use the {@link #getConnection()}
...
public interface ConnectionHandler<T> {
  ...
  /**
   * Returns the connection that's being wrapped. The actual implications of
   * invoking this method depends on the implementation.
   * <p>
   ...
   * connection ready to be used or throw a {@link ConnectionException}
   *
