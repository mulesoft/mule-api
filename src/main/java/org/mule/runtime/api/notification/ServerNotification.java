 ...
 * <p>
 * The nature of the event that occurred is identified by the concrete type of the {@link ServerNotification} and its
 * {@link #getAction() action}.
 * <p>
 * The concrete type of the {@link ServerNotification} is an indication of the kind of component that caused the event, and in may
...
public interface ServerNotification {
   ...
   *         {@link ServerNotificationFirer#fire(ServerNotification)} or will be dispatched to a {@link Scheduler} for
  ...
  /**
   * Indicates the kind of action that causes a {@link ServerNotification} to be fired.
   */
