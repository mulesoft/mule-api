 ...
 * <p/>
 * Each {@link MulePluginProperty} will have an ID that will be used to discover any loader that's responsible of working
 * with the current set of attributes. It's up to each loader to validate the types, size and all that matters around
 * the attributes.
 *
 * @since 1.0
 */
public class MulePluginProperty {

  private final String id;
  private final Map<String, Object> attributes;

  /**
   * Creates an immutable implementation of {@link MulePluginProperty}
   *
   * @param id ID of the descriptor
   * @param attributes collection of attributes
   */
  public MulePluginProperty(String id, Map<String, Object> attributes) {
    this.id = id;
