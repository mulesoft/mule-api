...
public class MediaTypeTestCase {
  ...
  @Test
  public void takeIntoAccountKnownParamName() throws Exception {
    Method setter = MediaType.class.getDeclaredMethod("setKnownParamNames", List.class);
    setter.setAccessible(true);
    setter.invoke(null, asList("a", "b", "c"));
    try {
